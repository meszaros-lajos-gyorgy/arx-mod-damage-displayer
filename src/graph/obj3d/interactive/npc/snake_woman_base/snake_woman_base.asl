...
//#
 SET_BLOOD 0.1 0.1 0.9
 SETSTAREFACTOR 0.7
 PHYSICAL RADIUS 30
 PHYSICAL HEIGHT 190
  SET_NPC_STAT reach 20
 SET_NPC_STAT RESISTMAGIC 60
 SET_NPC_STAT RESISTPOISON 70
 ...
 SET_NPC_STAT mana 10000
 SET_XP_VALUE 400
 SETNAME [description_snake_woman]
 INVENTORY CREATE
 ...
 SET £friend "edurneum"
 SET £type "snake_woman"
//**CASTERS ONLY
 TIMERspell_decision -i 0 4 SENDEVENT SPELLDECISION SELF ""
 SET §casting_lvl 8            //set level of casting, any NPC = 0, highpriests = 3, snakewom = 6, lich = 10
 SET §spell_ready 1            //to remove later, to simulate the spell system
 LOADANIM CAST_START                 "snake_woman_cast_spell_in"
 LOADANIM CAST_CYCLE                 "snake_woman_cast_spell_cycle"
 LOADANIM CAST                       "snake_woman_cast_spell_cast"
 LOADANIM CAST_END                   "snake_woman_cast_spell_out"  //un de trop ?
//** END CASTERS ONLY
 LOADANIM WALK_SNEAK                 "snake_woman_normal_walk"    //*****************  NEW
// loadanim BARE_READY                 "snake_woman_cast_spell_in"
// loadanim BARE_UNREADY               "snake_woman_cast_spell_out"
 loadanim BARE_WAIT                  "snake_woman_fight_wait_toponly"
 loadanim BARE_STRIKE_LEFT_START     "snake_woman_attack_start" 
 loadanim BARE_STRIKE_LEFT_CYCLE     "snake_woman_attack_cycle"
 loadanim BARE_STRIKE_LEFT           "snake_woman_attack_strike"
 loadanim BARE_STRIKE_RIGHT_START    "snake_woman_attack_start"
 loadanim BARE_STRIKE_RIGHT_CYCLE    "snake_woman_attack_cycle"
 loadanim BARE_STRIKE_RIGHT          "snake_woman_attack_strike"
 loadanim BARE_STRIKE_TOP_START      "snake_woman_attack_start"
 loadanim BARE_STRIKE_TOP_CYCLE      "snake_woman_attack_cycle"
 loadanim BARE_STRIKE_TOP            "snake_woman_attack_strike"
 loadanim BARE_STRIKE_BOTTOM_START   "snake_woman_attack_start"
 loadanim BARE_STRIKE_BOTTOM_CYCLE   "snake_woman_attack_cycle"
 loadanim BARE_STRIKE_BOTTOM         "snake_woman_attack_strike"
 LOADANIM GRUNT                      "snake_woman_grunt"
 loadanim FIGHT_STRAFE_RIGHT         "snake_woman_strafe_right"
 loadanim FIGHT_STRAFE_LEFT          "snake_woman_strafe_left"
 LOADANIM WALK                       "snake_woman_normal_walk"
 LOADANIM RUN                        "snake_woman_normal_run"
 LOADANIM WAIT                       "snake_woman_normal_wait"
 LOADANIM HIT                        "snake_woman_receive_damage"
 LOADANIM HIT_SHORT                  "snake_woman_hit_short"
 LOADANIM DIE                        "snake_woman_death"
 LOADANIM TALK_NEUTRAL               "snake_woman_talk_neutral_headonly"
 LOADANIM TALK_HAPPY                 "snake_woman_talk_happy_headonly"
 LOADANIM TALK_ANGRY                 "snake_woman_talk_angry_headonly"
 loadanim FIGHT_WALK_FORWARD         "snake_woman_normal_walk"
 loadanim FIGHT_WALK_BACKWARD        "snake_woman_normal_walk_back"
 loadanim FIGHT_WAIT                 "snake_woman_fight_wait"
 SET £hail [snake_hail]
 SET £thief [snake_thief]
 SET £strike []
 SET £victory []
 SET £whogoesthere [snake_grunt]
 SET £heardnoise [snake_grunt]
 SET £back2guard [snake_grunt]
 SET £misc [snake_misc]
 SET £threat [snake_threat]
 SET £search []
 SET £youmad [snake_grunt]
 SET £dying [snake_dying]
 SET £ouch [snake_ouch]
 SET £ouch_medium [snake_ouch_medium]
 SET £ouch_strong [snake_ouch_strong]
 SET £help [snake_help]
 SET £comeback [snake_grunt]
 SET £justyouwait [snake_grunt]
 ACCEPT
}

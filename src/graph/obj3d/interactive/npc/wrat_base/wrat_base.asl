...
//#
 SETNAME [description_rat]

 SET_NPC_STAT reach -20
 SET_NPC_STAT RESISTMAGIC 99
 SET_NPC_STAT RESISTPOISON 99
 SET_NPC_STAT RESISTFIRE 99
 SET_NPC_STAT armor_class 40
 SET_NPC_STAT absorb 30
 SET_NPC_STAT damages 10
 SET_NPC_STAT tohit 150
 SET_NPC_STAT aimtime 1
 SET_NPC_STAT life 800
 SET_XP_VALUE 1000
 SET_MATERIAL FLESH
 ...
 loadanim BARE_READY                 "rat_fight_attack_start"
 loadanim BARE_UNREADY               "rat_fight_attack_strike"
 loadanim BARE_WAIT                  "rat_fight_attack_wait_toponly"
 loadanim BARE_STRIKE_LEFT_START     "rat_fight_attack_start" 
 loadanim BARE_STRIKE_LEFT_CYCLE     "rat_fight_attack_cycle"
 loadanim BARE_STRIKE_LEFT           "rat_fight_attack_strike"
 loadanim BARE_STRIKE_RIGHT_START    "rat_fight_attack_start"
 loadanim BARE_STRIKE_RIGHT_CYCLE    "rat_fight_attack_cycle"
 loadanim BARE_STRIKE_RIGHT          "rat_fight_attack_strike"
 loadanim BARE_STRIKE_TOP_START      "rat_fight_attack_start"
 loadanim BARE_STRIKE_TOP_CYCLE      "rat_fight_attack_cycle"
 loadanim BARE_STRIKE_TOP            "rat_fight_attack_strike"
 loadanim BARE_STRIKE_BOTTOM_START   "rat_fight_attack_start"
 loadanim BARE_STRIKE_BOTTOM_CYCLE   "rat_fight_attack_cycle"
 loadanim BARE_STRIKE_BOTTOM         "rat_fight_attack_strike"

 LOADANIM GRUNT                      "rat_grunt"  //*****************  NEW
 loadanim FIGHT_WALK_FORWARD         "rat_walk_fight"
 loadanim FIGHT_WALK_BACKWARD        "rat_fight_run_backward"
//loadanim FIGHT_STRAFE_RIGHT         "rat_strafe_right"
//loadanim FIGHT_STRAFE_LEFT          "rat_strafe_left"
 LOADANIM WALK                       "rat_walk"
 LOADANIM RUN                        "rat_run"
 LOADANIM WAIT                       "rat_wait"
 loadanim FIGHT_WAIT                 "rat_fight_wait"
 LOADANIM HIT                        "rat_fight_hit"
 LOADANIM HIT_SHORT                  "rat_hit_short"
 LOADANIM DIE                        "rat_death"


 SET £hail "rat_detect"
 SET £strike "rat_attack"
 SET £misc "rat_idle"
 SET £threat "none"
 SET £dying "rat_die"
 SET £ouch "rat_hit"
 SET £ouch_medium "rat_hit"
 SET £ouch_strong "rat_hit"
 IF (§sound_amount > 0)
 SET #TMP ~^RND_6~
 INC #TMP 6
